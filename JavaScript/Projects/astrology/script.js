...
form.addEventListener("submit", (e) => {
  ...
  const zodiacSign = zodiacSigns[(day + month) % 12];
  const compliment =
  ...
  result.textContent = `Dear ${name} ${surname},
  Based on your birth date (${day}/${month}/${year}), your zodiac sign is ${zodiacSign}.
  ${compliment}
  ${prediction}
  ${recommendation}
  ${victimCardCompliment}`;
});
